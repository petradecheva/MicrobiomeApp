  ...
  navbarPage("Microbiome", tabsetPanel(id = "tabs",
                                       tabPanel(
                                         ...
                                         HTML(r"(<div class="row">
                                              ...
                                              <div class="row">
                                              <div class="col-sm-12">
                                              <span class="help-block">Each file/table needs to have the specified columns:
                                              </span>
                                              </div>
                                              </div><div class="row">
                                              <div class="col-sm-12">
                                              <span class="help-block">
                                              Metadata table (from metadata file)- sample_id, disease_stat
                                              </span>
                                              </div>
                                              </div>
                                              <div class="row">
                                              <div class="col-sm-12">
                                              <span class="help-block">
                                              Otu_Counts table (from subsample.shared file) - Group and columns that start with Otu
                                              </span>
                                              </div>
                                              </div><div class="row">
                                              <div class="col-sm-12">
                                              <span class="help-block">
                                              Taxonomy  (from cons.taxonomy file) - OTU, Taxonomy
                                              </span>
                                              </div>
                                              </div>
                                              <br><div class="row">
                                              ...
                                              You can use these files as reference: </span>
                                        )"),
                                        downloadButton("btemp_mt", "metadata"),
                                        downloadButton("btemp_otu", "otu_counts"),
                                        downloadButton("btemp_tax", "taxonomy"),
                                        HTML(r"(
                                             </div>
                                             </div>
                                             </form>
